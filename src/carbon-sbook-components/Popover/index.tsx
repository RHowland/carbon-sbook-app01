...
import useIsomorphicEffect from '../../carbon-sbook-util/internal/useIsomorphicEffect';
import { useMergedRefs } from '../../carbon-sbook-util/internal/useMergedRefs';
...
import { useWindowEvent } from '../../carbon-sbook-util/internal/useEvent';
import { mapPopoverAlignProp } from '../../carbon-sbook-util/tools/createPropAdapter';
import {
  useFloating,
  flip,
  autoUpdate,
...
export type PopoverProps<E extends React.ElementType> = PolymorphicProps<
  E,
  PopoverBaseProps
>;
